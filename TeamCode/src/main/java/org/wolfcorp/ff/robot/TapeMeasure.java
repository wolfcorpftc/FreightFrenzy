...
public class TapeMeasure {
    ...
    public static final double TAPE_ROTATE_SPEED = 0.006;
    public static final double TAPE_SLOW_ROTATE_SPEED = 0.0004;

    private static final double TAPE_FORWARD_ROTATE = 0.84;
