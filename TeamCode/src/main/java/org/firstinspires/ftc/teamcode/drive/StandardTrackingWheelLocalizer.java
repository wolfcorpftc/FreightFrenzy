...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12 + 11.0 / 16; // in; distance between the left and right wheels
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        super(Arrays.asList(
                new Pose2d(0.5, LATERAL_DISTANCE / 2, 0), // left
                new Pose2d(0.5, -LATERAL_DISTANCE / 2, 0), // right
                new Pose2d(FORWARD_OFFSET, -0.75, Math.toRadians(90)) // front
        ));
